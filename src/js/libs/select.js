...
// Базовые стили заключаются в src/scss/forms.scss
...
Для элемента (option):
data-class="ім'я класу" - добавляет класс
...
class SelectConstructor {
	constructor(props, data = null) {
		...
		this.selectClasses = {
			...
			classSelectLabel: "select__label", // Лейбел
	...
	selectAction(selectItem) {
		...
		// Если селекты размещены в элементе с атрибутом дата data-one-select
